...
export const aggregators: AggregatorDefinition[] = [
  ...
  },
  {
    ...
    name: "Sony official",
    type: "manufacturer",
    baseUrl: "https://www.sony.com",
    authorityScore: 93,
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "audio", "gaming", "support"],
    sampleDomains: ["sony.com", "sony.es", "sony.co.uk", "sony.de", "sony.fr", "sony.jp", "electronics.sony.com", "playstation.com", "support.playstation.com", "support.sony.com"],
    description: "Official Sony and PlayStation product surfaces for device names, audio specs, console details, and support data.",
    confidencePolicy: "Use as canonical evidence for Sony product identity, model facts, compatibility, and published technical specifications.",
  },
  {
    id: "lg-official",
    name: "LG official",
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "televisions", "monitors", "support"],
    sampleDomains: ["lg.com", "lg.com/us", "lg.com/uk", "lg.com/es", "lg.com/de", "lg.com/fr", "lg.com/support", "lgnewsroom.com", "lge.co.kr", "lgparts.com"],
    description: "Official LG product and support source for TVs, monitors, home entertainment, and appliance-adjacent devices.",
    confidencePolicy: "Use as canonical evidence for LG model names, display technology, ports, manuals, and product support facts.",
  },
  {
    id: "xiaomi-official",
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "phones", "tablets", "wearables"],
    sampleDomains: ["mi.com", "mi.com/es", "mi.com/global", "xiaomi.com", "po.co", "redmi.com", "xiaomiui.net", "c.mi.com", "app.mi.com", "home.mi.com"],
    description: "Official Xiaomi, Redmi, and POCO surfaces for phones, tablets, wearables, and connected devices.",
    confidencePolicy: "Use as canonical evidence for Xiaomi-family product naming, battery, display, storage, and connectivity details.",
  },
  {
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "gaming", "compatibility", "support"],
    sampleDomains: ["nintendo.com", "nintendo.es", "nintendo.co.uk", "nintendo.de", "nintendo.fr", "nintendo.co.jp", "support.nintendo.com", "accounts.nintendo.com", "ec.nintendo.com", "my.nintendo.com"],
    description: "Official Nintendo source for console identity, game compatibility, bundles, accessories, and support facts.",
    confidencePolicy: "Use as canonical evidence for Nintendo product names, compatibility, bundle content, and platform requirements.",
  },
  {
    id: "microsoft-xbox-official",
    name: "Microsoft Xbox official",
    type: "manufacturer",
    baseUrl: "https://www.xbox.com",
    authorityScore: 93,
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "gaming", "support", "compatibility"],
    sampleDomains: ["xbox.com", "support.xbox.com", "microsoft.com", "support.microsoft.com", "account.microsoft.com", "news.xbox.com", "learn.microsoft.com", "apps.microsoft.com", "answers.microsoft.com", "store.microsoft.com"],
    description: "Official Xbox and Microsoft source for console, accessory, service, and compatibility details.",
    confidencePolicy: "Use as canonical evidence for Xbox names, compatibility, storage, controller support, and official requirements.",
  },
  {
    id: "asus-official",
    name: "ASUS official",
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "laptops", "monitors", "components"],
    sampleDomains: ["asus.com", "rog.asus.com", "asus.com/us", "asus.com/es", "asus.com/de", "asus.com/support", "dlcdnets.asus.com", "zentalk.asus.com", "asuswebstorage.com", "shop.asus.com"],
    description: "Official ASUS and ROG product source for laptops, monitors, phones, routers, and PC components.",
    confidencePolicy: "Use as canonical evidence for ASUS model families, configurations, manuals, and hardware specifications.",
  },
  {
    id: "acer-official",
    name: "Acer official",
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "laptops", "monitors", "support"],
    sampleDomains: ["acer.com", "acer.com/us-en", "acer.com/es-es", "acer.com/ac/en/US", "community.acer.com", "store.acer.com", "support.acer.com", "drivers.acer.com", "predator.acer.com", "planet9.gg"],
    description: "Official Acer product and support source for laptops, monitors, Chromebooks, and gaming devices.",
    confidencePolicy: "Use as canonical evidence for Acer model identity, display, storage, memory, and support documentation.",
  },
  {
    id: "hp-official",
    name: "HP official",
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "laptops", "printers", "support"],
    sampleDomains: ["hp.com", "support.hp.com", "hpe.com", "store.hp.com", "instantink.hpconnected.com", "developers.hp.com", "community.hp.com", "parts.hp.com", "ftp.hp.com", "kaas.hpcloud.hp.com"],
    description: "Official HP source for computers, printers, displays, peripherals, manuals, and support metadata.",
    confidencePolicy: "Use as canonical evidence for HP model names, configuration details, warranty-facing identity, and manuals.",
  },
  {
    id: "dell-official",
    name: "Dell official",
    ...
    enabled: true,
    coverageTags: ["manufacturer-specs", "laptops", "monitors", "support"],
    sampleDomains: ["dell.com", "support.dell.com", "downloads.dell.com", "delltechnologies.com", "alienware.com", "dell.com/support", "dell.com/community", "dell.com/en-us", "dell.com/es-es", "dell.com/de-de"],
    description: "Official Dell and Alienware source for laptops, desktops, monitors, configurations, and service documents.",
    confidencePolicy: "Use as canonical evidence for Dell model configuration, monitor specs, service tags, and official manuals.",
  },
  {
    id: "msi-official",
    name: "MSI official",
    ...
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["manufacturer-specs", "gaming-laptops", "components", "monitors"],
    sampleDomains: ["msi.com", "msi.com/Laptop", "msi.com/Motherboard", "msi.com/Graphics-Card", "msi.com/Monitor", "forum-en.msi.com", "download.msi.com", "storage-asset.msi.com", "register.msi.com", "account.msi.com"],
    description: "Official MSI source for gaming laptops, monitors, motherboards, GPUs, and component documentation.",
    confidencePolicy: "Use as canonical evidence for MSI product models, component specifications, manuals, and regional variants.",
  },
  {
    id: "pccomponentes-retail",
    name: "PcComponentes retail",
    type: "retailer",
    baseUrl: "https://www.pccomponentes.com",
    authorityScore: 69,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["spanish-retail", "pc-components", "consumer-electronics"],
    sampleDomains: ["pccomponentes.com", "pccomponentes.pt", "help.pccomponentes.com", "blog.pccomponentes.com", "premium.pccomponentes.com", "pccomponentes.com/gaming", "pccomponentes.com/smartphones", "pccomponentes.com/portatiles", "pccomponentes.com/monitores", "pccomponentes.com/componentes"],
    description: "Spanish electronics retailer for market-visible specs, bundles, pricing context, and consumer electronics availability.",
    confidencePolicy: "Use as corroborating retail evidence for visible specs and availability; require stronger sources for canonical fields.",
  },
  {
    id: "elcorteingles-retail",
    name: "El Corte Ingles retail",
    type: "retailer",
    baseUrl: "https://www.elcorteingles.es",
    authorityScore: 66,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["spanish-retail", "consumer-electronics", "commercial-copy"],
    sampleDomains: ["elcorteingles.es", "elcorteingles.pt", "viajeselcorteingles.es", "seguros.elcorteingles.es", "supermercado.elcorteingles.es", "empresas.elcorteingles.es", "tarjeta.elcorteingles.es", "elcorteingles.es/electronica", "elcorteingles.es/videojuegos", "elcorteingles.es/informatica"],
    description: "Spanish department-store retailer used for local commercial availability, product copy, and visible specifications.",
    confidencePolicy: "Use as medium-authority corroboration for local retail facts, not as sole proof for manufacturer-controlled attributes.",
  },
  {
    id: "fnac-retail",
    name: "Fnac retail",
    ...
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["european-retail", "gaming", "consumer-electronics"],
    sampleDomains: ["fnac.com", "fnac.es", "fnac.pt", "fnac.be", "fnac.ch", "static.fnac-static.com", "secure.fnac.com", "billetterie.fnac.com", "pro.fnac.com", "adherents.fnac.com"],
    description: "European retailer source for consumer electronics, gaming, media, and local bundle visibility.",
    confidencePolicy: "Use as corroborating retail evidence for visible fields and bundles; do not let retail copy override official sources.",
  },
  {
    id: "coolblue-retail",
    name: "Coolblue retail",
    type: "retailer",
    baseUrl: "https://www.coolblue.nl",
    authorityScore: 67,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["benelux-retail", "consumer-electronics", "visible-specs"],
    sampleDomains: ["coolblue.nl", "coolblue.be", "coolblue.de", "coolblue.nl/en", "coolblue.be/en", "coolblue.de/en", "assets.coolblue.nl", "manuals.coolblue.nl", "business.coolblue.nl", "jobs.coolblue.nl"],
    description: "Benelux electronics retailer used for structured visible specs, advice copy, and local availability context.",
    confidencePolicy: "Use for corroborating retail-visible specs; prefer manufacturer and specialist evidence for final field acceptance.",
  },
  {
    id: "currys-retail",
    name: "Currys retail",
    ...
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["uk-retail", "consumer-electronics", "commercial-copy"],
    sampleDomains: ["currys.co.uk", "business.currys.co.uk", "currys.ie", "knowhow.com", "teamknowhow.com", "currys.co.uk/services", "currys.co.uk/gaming", "currys.co.uk/computing", "currys.co.uk/tv-and-audio", "currys.co.uk/phones"],
    description: "UK electronics retailer for market-visible product information, bundles, and retail availability signals.",
    confidencePolicy: "Use as medium-confidence retail corroboration only; canonical attributes require official or specialist confirmation.",
  },
  {
    id: "displayspecifications-db",
    name: "DisplaySpecifications",
    type: "spec_database",
    baseUrl: "https://www.displayspecifications.com",
    authorityScore: 82,
    defaultConfidence: "high",
    enabled: true,
    coverageTags: ["display-specs", "monitors", "televisions"],
    sampleDomains: ["displayspecifications.com", "displayspecifications.com/en", "displayspecifications.com/es", "displayspecifications.com/de", "displayspecifications.com/fr", "displayspecifications.com/ru", "displayspecifications.com/it", "displayspecifications.com/bg", "displayspecifications.com/zh", "displayspecifications.com/ja"],
    description: "Structured display database for monitors, TVs, panel details, refresh rates, and physical dimensions.",
    confidencePolicy: "Use for structured display data when manufacturer pages are unavailable or need normalization.",
  },
  {
    id: "kimovil-specs",
    name: "Kimovil specs",
    type: "spec_database",
    baseUrl: "https://www.kimovil.com",
    authorityScore: 76,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["phones", "tablets", "price-history", "spec-database"],
    sampleDomains: ["kimovil.com", "kimovil.com/en", "kimovil.com/es", "kimovil.com/fr", "kimovil.com/de", "kimovil.com/it", "kimovil.com/pt", "kimovil.com/ru", "kimovil.com/zh", "kimovil.com/ar"],
    description: "Mobile-device specification and market comparison source for phones and tablets.",
    confidencePolicy: "Use for mobile specification corroboration; validate product identity and regional variant claims elsewhere.",
  },
  {
    id: "versus-comparison",
    name: "Versus comparison",
    type: "spec_database",
    baseUrl: "https://versus.com",
    authorityScore: 58,
    defaultConfidence: "low",
    enabled: true,
    coverageTags: ["comparison", "consumer-electronics", "spec-hints"],
    sampleDomains: ["versus.com", "versus.com/en", "versus.com/es", "versus.com/fr", "versus.com/de", "versus.com/it", "versus.com/pt", "versus.com/ru", "versus.com/ja", "versus.com/zh"],
    description: "Comparison site useful for quick spec hints across broad consumer electronics categories.",
    confidencePolicy: "Use as low-to-medium corroboration only; comparison-site facts need stronger confirmation before export.",
  },
  {
    id: "soundguys-reviews",
    name: "SoundGuys reviews",
    type: "review_site",
    baseUrl: "https://www.soundguys.com",
    authorityScore: 77,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["audio", "headphones", "lab-measurements", "reviews"],
    sampleDomains: ["soundguys.com", "soundguys.com/reviews", "soundguys.com/best", "soundguys.com/news", "soundguys.com/guides", "soundguys.com/learn", "soundguys.com/headphones", "soundguys.com/earbuds", "soundguys.com/microphones", "soundguys.com/speakers"],
    description: "Audio review and measurement source for headphones, earbuds, speakers, and microphone behavior.",
    confidencePolicy: "Use for audio performance and measured features; manufacturer sources still decide canonical identity and SKU fields.",
  },
  {
    id: "displayninja-guides",
    name: "DisplayNinja guides",
    type: "review_site",
    baseUrl: "https://www.displayninja.com",
    authorityScore: 71,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["monitors", "display-guides", "refresh-rate", "panel-tech"],
    sampleDomains: ["displayninja.com", "displayninja.com/monitor-list", "displayninja.com/reviews", "displayninja.com/best-monitor", "displayninja.com/new-monitors", "displayninja.com/ips-vs-va-vs-tn", "displayninja.com/hdr", "displayninja.com/g-sync", "displayninja.com/free-sync", "displayninja.com/oled"],
    description: "Display guide and review source for monitor panels, refresh rates, VRR features, and buying context.",
    confidencePolicy: "Use as supporting evidence for monitor feature claims; validate exact model specs with manufacturer material.",
  },
  {
    id: "adorama-retail",
    name: "Adorama retail",
    type: "retailer",
    baseUrl: "https://www.adorama.com",
    authorityScore: 65,
    defaultConfidence: "medium",
    enabled: true,
    coverageTags: ["camera", "audio", "pro-equipment", "retail-specs"],
    sampleDomains: ["adorama.com", "adorama.com/alc", "adorama.com/business", "adorama.com/used", "adorama.com/rentals", "adorama.com/giftcards", "adorama.com/help", "adorama.com/deals", "adorama.com/brand", "adorama.com/catalog"],
    description: "Specialist retailer for photography, audio, video, computing, and creator equipment.",
    confidencePolicy: "Use as corroborating retailer evidence for visible specs and bundles; do not treat retail copy as canonical alone.",
  },
]
...
function hasStorefrontDescriptionNoise(row: CatalogItemRow) {
  return /ver opiniones|desde\s*\/mes|vendido por|enviado por|entrega desde|garant[ií]as y devoluciones|item no\.|financiaci[oó]n|a plazos/i.test(row.description)
}

function shouldKeepCatalogWarning(row: CatalogItemRow, warning: string) {
  if (/descripci[oó]n.*(?:promocional|tienda)/i.test(warning)) {
    return hasStorefrontDescriptionNoise(row)
  }
  return true
}
...
function buildCatalogItemProducts(rows: readonly CatalogItemRow[]): ProductRecord[] {
  return rows.map((row): ProductRecord => {
    const schema = getSchemaForProduct(row.schemaId)
    const warnings = [...row.warnings.filter((warning) => shouldKeepCatalogWarning(row, warning)), ...getMissingRequiredWarnings(row)]
...
const baseProducts: ProductRecord[] = [
  {
    ...
    sourceUrl: "https://www.mediamarkt.es/es/product/_auriculares-true-wireless-huawei-freeclip-2-38h-autonomia-ip57-open-ear-llamadas-nitidas-conexion-a-dos-dispositivos-blanco-1617473.html",
    listingStatus: "NEEDS_ENRICHMENT",
    qualityScore: 0,
    scoreBand: "red",
    baselineDescription: "",
    warnings: ["Brand is required", "Description missing", "EAN requires review"],
  ...
  },
  {
    ...
    schemaId: "schema-smartphones",
    sourceUrl: "https://www.samsung.com/es/search/?searchvalue=Galaxy%20A55",
    listingStatus: "READY_FOR_REVIEW",
    qualityScore: 0,
    scoreBand: "yellow",
    baselineDescription: "Descripción base de smartphone con detalle de cámara pendiente y formato de almacenamiento inconsistente.",
    ...
    baselineAttributes: {
      ...
      ram: "8 GB",
      displaySize: "6.6 in",
      description: "Smartphone de gama media equilibrado con pantalla AMOLED y batería para todo el día.",
    },
    bestEvidenceByField: {},
    evidence: [],
    candidates: [],
  },
  {
    ...
    sourceUrl: "https://www.lg.com/es/search/?search=LG%20OLED%20C4%2055",
    listingStatus: "READY_FOR_REVIEW",
    qualityScore: 0,
    scoreBand: "yellow",
    baselineDescription: "Descripción base sólida para televisor, pendiente de completar la frecuencia de refresco.",
    ...
    baselineAttributes: {
      ...
      description: "Televisor OLED premium con contraste cinematográfico y funciones de Smart TV.",
    },
    bestEvidenceByField: {},
    evidence: [],
    candidates: [],
  },
  {
    ...
    categoryPath: ["Audio", "Headphones & Earbuds"],
    schemaId: "schema-headphones-earbuds",
    sourceUrl: "https://www.sony.es/search?searchString=WH-1000XM5",
    listingStatus: "READY_FOR_REVIEW",
    qualityScore: 0,
    scoreBand: "blue",
    baselineDescription: "La descripción base es utilizable, pero faltan detalles del micrófono.",
    ...
    baselineAttributes: {
      ...
      connectivity: "Bluetooth",
      weight: "250 g",
      description: "Auriculares inalámbricos circumaurales con cancelación activa de ruido.",
    },
    bestEvidenceByField: {},
    evidence: [],
    candidates: [],
  },
  {
    ...
    schemaId: "schema-tablets",
    sourceUrl: "https://www.mi.com/es/search?keyword=Redmi%20Pad%20Pro",
    listingStatus: "NEEDS_ENRICHMENT",
    qualityScore: 0,
    scoreBand: "yellow",
    baselineDescription: "Ficha de tablet utilizable, pendiente de compatibilidad con stylus y detalle de batería.",
    ...
    baselineAttributes: {
      ...
      displaySize: "12.1 in",
      storage: "256 GB",
      description: "Tablet Android de gran formato para contenido multimedia y productividad.",
    },
    bestEvidenceByField: {},
    evidence: [],
    candidates: [],
