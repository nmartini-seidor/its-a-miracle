...
test('app header uses the Data Harbor static logo', () => {
  ...
  assert.equal(brandMarkup.includes('src="/data-harbor-logo.svg?v=wordmark-right-20260510"'), true)
  ...
  assert.equal(logoSource.includes('viewBox="488 293 1060 250"'), true)
  assert.equal(logoSource.includes('width="1060.000000pt" height="250.000000pt"'), true)
  assert.equal(brandMarkup.includes('width={1060}'), true)
  assert.equal(brandMarkup.includes('height={250}'), true)
